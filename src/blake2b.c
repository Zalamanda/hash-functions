 ...
 * which was released under the Creative Commons Zero (CC0) v1.0
 * Universal license and is therefore used with permission, and
 * with much gratitude.  \(^-^)/
 *
 ...
 *
 * *** NOTE: This implementation removes the 128-bit "total bytes"
 * context variable and operations in favour of a 64-bit alternate.
 * To restore the 128-bit functionality, simply remove the comment
 * notation throughout this file where necessary.
 *
 * ****************************************************************/

#ifndef _BLAKE2B_C
#define _BLAKE2B_C  /* include guard */


#include <stddef.h>
#include <stdint.h>

#ifndef BLAKE2B_256_LENGTH
#define BLAKE2B_256_LENGTH  32
#endif

#ifndef BLAKE2B_384_LENGTH
#define BLAKE2B_384_LENGTH  48
#endif

#ifndef BLAKE2B_512_LENGTH
#define BLAKE2B_512_LENGTH  64
#endif
